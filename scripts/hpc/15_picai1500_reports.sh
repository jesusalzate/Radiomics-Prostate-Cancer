...
RAD_DL_POST_DIR="${BASE_DIR}/dl/radiomics_only/picai1500_radiomics_only_5fold_threshold_postprocess"
...
test -f "${BASE_DIR}/dl/radiomics_only/picai1500_radiomics_only_5fold_suite_manifest.json"
...
test -f "${BASE_DIR}/dl/clinical_only/picai1500_clinical_only_5fold_suite_manifest.json"
test -f "${BASE_DIR}/dl/concat/picai1500_concat_5fold_suite_manifest.json"
...
prostate-radiomics compare \
  ...
  --prediction "transformer=${RAD_DL_POST_DIR}/picai1500_radiomics_only_5fold_transformer/cv_oof_predictions_thresholds.csv" \
  --prediction "capsnet=${RAD_DL_POST_DIR}/picai1500_radiomics_only_5fold_capsnet/cv_oof_predictions_thresholds.csv" \
  --prediction "transformer_capsnet=${RAD_DL_POST_DIR}/picai1500_radiomics_only_5fold_transformer_capsnet/cv_oof_predictions_thresholds.csv"
