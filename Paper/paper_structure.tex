...
multiplicity adjustment ($\Delta$AUROC 0.014; Holm-adjusted $P=0.070$).
...
vs.\ 0.84 elsewhere) in every model family including TabFM, and model-agnostic
...
multiplicity adjustment ($\Delta$AUROC $+0.014$; Holm-adjusted $P=0.070$),
although AUPRC was ($\Delta=+0.045$; Holm-adjusted $P=0.018$;
